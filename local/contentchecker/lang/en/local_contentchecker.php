...
$string['suggest:diagram'] = 'Diagram drawn for this concept';
$string['suggest:insertdiagram'] = 'Insert this diagram';
$string['error:diagramempty'] = 'There is no diagram source to insert.';
$string['error:diagraminvalid'] = 'That is not valid diagram source. It must begin with graph, flowchart, sequenceDiagram, classDiagram or mindmap.';
